...
public class ReservationDAO {
    ...
    /**
     * Method executes INSERT query of provided reservation represented by Reservation class object.
     * @param reservation reservation represented by Reservation class object
    ...
    /**
     * Method allows to insert provided data to database in proper way by separating room numbers and reservation.
     * @param reservation reservation represented by Reservation class object
     * @param rooms room numbers booked in provided reservation
    ...
    /**
     * Method fetch all reservations from database in format suitable for UI to be displayed.
     * @return Collection of objects which represents reservations stored in database.
     * @throws SQLException thrown when sql error appears
     * @throws ClassNotFoundException thrown when JDBC Driver is not found
     */
    ...
    /**
     * Method creates Reservation objects which represents data fetched from database.
     * these objects are populated which proper data which describes them.
     * @param resultSet data fetched from database which represents reservations.
     * @return Collection of objects which represents reservations stored in database.
     * @throws SQLException thrown when sql error appears
     */
